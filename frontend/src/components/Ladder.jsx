...
function Ladder() {
  ...
  return (
    <div className='flex-col'>
      ...
      <table className="table-auto text-left border-separate border-spacing-x-2 border-spacing-y-2">
        <thead>
          ...
          <tbody>
              {data.map(player => (
                <tr key={player.id} className="odd:bg-gray-50 text-center">
                  ...
                  <td className="px-2 py-2">{player.nickname}</td>
                  ...
                  <td className="px-2 py-2">{player.wins}</td>
                  <td className="px-2 py-2">{player.losses}</td>
                </tr>
              ))}
          </tbody>
      </table>
